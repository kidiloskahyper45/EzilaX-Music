...
from EzilaXMusicV.config import ARQ_API_KEY
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nor manually add [assistant](https://t.me/EzilaXHelper) to your Group and try again</b>",
                    )
    try:
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        thumbnail = "https://telegra.ph/file/584b1539d736325fab377.jpg"
...
async def lol_cb(b, cb):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            reply_markup=keyboard,
            caption=f"▶️ <b>Playing</b> here the song requested by {r_by.mention} via <b>EzilaX Music</b> 😎",
        )
